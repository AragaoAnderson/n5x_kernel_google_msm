...
static struct l2_level l2_freq_tbl[] __initdata = {
	[0]  = { {  96000, PLL_8, 0, 0x00 },  950000, 1050000, 1 },
	[1]  = { {  192000, HFPLL, 2, 0x20 }, 1050000, 1050000, 2 },
	[2]  = { {  384000, HFPLL, 2, 0x24 }, 1050000, 1050000, 2 },
...
static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {   96000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   975000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   975000 },
	{ 1, {   486000, HFPLL, 2, 0x28 }, L2(5),  1000000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   96000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   925000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x28 }, L2(5),   950000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   96000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   875000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	{ 1, {   486000, HFPLL, 2, 0x28 }, L2(5),   900000 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   875000 },
	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	{ 0, {   486000, HFPLL, 2, 0x28 }, L2(5),   900000 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   925000 },
